    ...
    try {
        ...
        if (isCommand) {
            ...
            switch (command) {
                ...
                // always lands unless the target is bulletproof. Wipes their balance,
                // vehicle, house, inventory, and marriage vault, then locks them out of
                // every command for an hour.
                case 'kill': {
                    if (!mentionedJid) {

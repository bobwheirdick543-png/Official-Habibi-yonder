...
export async function handleIncomingMessage(sock, msg) {
    ...
    // Passes senderName so database updates user's WhatsApp pushName on every message
    const rewardInfo = await incrementTextCount(senderId, groupId, senderName)

    // Handle Infinite Level Progression & Text Rewards
    ...
    // Process Command with Typing Indicator
    ...
    // AI Response Trigger with Typing Indicator
